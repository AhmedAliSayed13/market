                        ...
                        <div class="card-body">
                            <form action="{{route('brand.update',$brand->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                        <div class="change-avatar">
                                            <div class="profile-img">
                                                <a id="aid" href="{{asset('images_profile/'.$brand->image)}}" data-fancybox data-caption="logo">
                                                    <img id="imgid" style="width: 200px;height: 150px" alt="User Image" src="{{asset('images_profile/'.$brand->image)}}">
                                                </a>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" value="{{old('name',$brand->name)}}" class="form-control @error('name') is-invalid @enderror" name="name">
                                        @error('name')

    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="{{route('home')}}"><img src="{{secure_asset("")}}main/img/logo.png" alt=""></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                                ...
                                @if(auth()->check())
                                <li class="nav-item"><a href="{{route('card.page')}}" class="cart"><span class="ti-bag mr-1 ml-1">
                                    {{ $cartCount }}
                                 @else
                                 <li class="nav-item"><a href="#" class="cart"><span class="ti-bag mr-1 ml-1">
                                    0
                                @endif
                                </span></a></li>
                        <li class="nav-item">
